...
keywords:
  ...
  - what is a responsible party ein
  - ein confirmation letter lost
...
<ProcessFlow title="Getting an EIN, in order" steps={[
  { label: "File the formation document and wait for acceptance", detail: "The application asks for a legal name and formation date that must already be true.", flag: "Do not apply before this" },
  { label: "Gather everything before you start", detail: "The online form times out and cannot be saved and resumed." },
  { label: "Identify the responsible party", detail: "A real individual who controls the entity. Never a formation service or registered agent." },
  { label: "Apply directly at irs.gov", detail: "Free. Numerous commercial sites charge a fee for the same federal form." },
  { label: "Copy the entity name character for character", detail: "From the stamped certificate, including punctuation and the designator." },
  { label: "Save the confirmation notice immediately", detail: "It appears once. The original cannot be reissued, only replaced." },
]} note="Most EIN problems are name mismatches between the state record, the IRS record and the bank." />
...
## What belongs with an accountant
