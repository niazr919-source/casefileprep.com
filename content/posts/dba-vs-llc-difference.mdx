...
keywords:
  ...
  - should I get a dba or an llc
  - does a dba protect me
  - dba vs llc for small business
  - can an llc have a trading name
  - difference between trade name and entity
tags:
  - DBA
  - LLC formation
  - business structure
...
<Comparison
  a={{
    title: "DBA",
    subtitle: "Registers a name",
    points: [
      "Puts on public record that a person or entity trades under a name",
      "Creates no legal entity and no separation of assets",
      "Does not change how the business is taxed",
      "Weak to no exclusive rights over the name",
      "Cheap to file, usually renewed every few years",
      "Filed with a county clerk or the state, depending where you are",
    ],
  }}
  b={{
    title: "LLC",
    subtitle: "Creates an entity",
    points: [
      "Creates a separate legal person that holds its own contracts and debts",
      "Provides liability separation, if maintained properly",
      "Default pass-through taxation, with elections available",
      "Name must be distinguishable in state records, but still not a trademark",
      "Higher cost, plus registered agent and annual filings",
      "Filed with the Secretary of State",
    ],
  }}
  verdict="They are not alternatives. A DBA registers a name; an LLC creates an entity. The common structure is an LLC trading under one or more registered DBAs - the entity provides the separation, the DBA provides the name customers see."
/>
