...
- **Certificate of good standing** from the state, sometimes required to be recent - which depends on [annual filings being current](/llc-annual-report-franchise-tax-calendar/).
