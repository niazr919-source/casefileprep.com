...
metaDescription: 'What to photograph, collect and record after a car accident, and how to build a claim file an adjuster can process. Educational, not legal advice.'
...
- **Every provider's records**: emergency department, urgent care, primary care, specialists, imaging, physical therapy. Keeping these [organised from the first appointment](/organizing-medical-records-injury-claim/) is far easier than reconstructing them later.
...
- **Storage charges.** Vehicle storage accrues daily and mounts quickly. Resolve where the vehicle sits early - and if the car is written off, the [total loss process](/car-declared-total-loss-what-happens/) has its own timetable.

## The point where documentation stops being enough
